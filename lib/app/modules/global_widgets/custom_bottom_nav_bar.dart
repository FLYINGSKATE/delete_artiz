...
class CustomBottomNavigationBar extends StatefulWidget {
  ...
  CustomBottomNavigationBar({this.backgroundColor = BACKGROUND_COLOR, this.itemColor = PRIMARY_COLOR, this.currentIndex = 0, @required this.children, this.onChange, this.unselectedColor});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: widget.children.map((item) {
          ...
          var unselectedColor= widget.unselectedColor;
          var icon = item.icon;
