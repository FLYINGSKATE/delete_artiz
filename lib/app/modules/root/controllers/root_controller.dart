...
import '../../booking_calendar/views/booking_calendar__view.dart';
...
import '../../youtube_gallery/controllers/youtube_gallery_controller.dart';
import '../../youtube_gallery/views/youtube_gallery_view.dart';
...
class RootController extends GetxController {
  ...
  Future<void> refreshPage(int _index) async {
    switch (_index) {
      case 0:
        {
          print("Refereshing Home");
          await Get.find<HomeController>().refreshHome();
          break;
        }
      case 1:
        {
          print("Refereshing Bookings");
          await Get.find<BookingsController>().refreshBookings();
          break;
        }
      case 2:
        {
          print("Refereshing Messages");
          await Get.find<MessagesController>().refreshMessages();
          break;
        }
      case 3:
        {
          print("Refereshing Youtube Gallery");
          await Get.find<YoutubeGalleryController>();
          break;
        }
    }
  }
