...
import '../modules/booking_calendar/views/booking_calendar__view.dart';
...
import '../modules/youtube_gallery/bindings/youtube_gallery_binding.dart';
import '../modules/youtube_gallery/views/youtube_gallery_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    //Ashraf
    GetPage(name: Routes.YOUTUBE_GALLERY, page: () => YoutubeGalleryView(), binding: YoutubeGalleryBinding(), middlewares: [AuthMiddleware()]),
    GetPage(name: Routes.BOOKING_CALENDAR, page: () => BookingCalendarView(), binding: BookingCalendarBinding(), middlewares: [AuthMiddleware()]),
  ];
}
